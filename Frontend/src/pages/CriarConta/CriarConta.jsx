    ...
    <View style={styles.container}>
      ...
      <View style={styles.topo}>
        <TouchableOpacity style={styles.botaoVoltar} onPress={voltar} activeOpacity={0.7}>
          <Ionicons name="chevron-back" size={26} color={styles.titulo.color} />
        </TouchableOpacity>
      ...
      <View style={styles.form}>
        ...
        <View style={styles.campoSenha}>
          ...
          />
          <TouchableOpacity onPress={alternarSenha}>
            <Ionicons
        ...
        <TouchableOpacity style={styles.botaoCriarConta} onPress={criarConta} activeOpacity={0.85}>
        ...
        <View style={styles.rodapeLogin}>
          ...
          <TouchableOpacity onPress={irParaLogin} activeOpacity={0.7}>
